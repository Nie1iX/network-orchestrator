...
export function ProfileIcon({ size = 18, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M15 9h4M15 13h4M6 16c.5-1.5 1.7-2 3-2s2.5.5 3 2" />
    </svg>
  );
}
...
export function categoryIcon(category: InterfaceCategory, size = 18): React.ReactElement {
  const props = { size };
  switch (category) {
    case "physical": return <EthernetIcon {...props} />;
    case "vpn": return <WireGuardIcon {...props} />;
    case "virtual": return <NetworkIcon {...props} />;
    case "system": return <LoopbackIcon {...props} />;
    case "tunnel": return <RouteIcon {...props} />;
    case "filter": return <NetworkIcon {...props} />;
  }
}
